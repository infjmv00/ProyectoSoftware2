...
-- Volcando datos para la tabla gestempresarial.tbldatos_empresa: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla gestempresarial.tblmenu: ~0 rows (aproximadamente)
DELETE FROM `tblmenu`;
INSERT INTO `tblmenu` (`idMenu`, `idRol`, `nombre`, `tipo`, `codigo_submenu`, `estado`, `url`) VALUES
	(1, 1, 'TRABAJADORES', 'S', NULL, b'1', NULL),
	(2, 1, 'NUEVO', 'I', 1, b'1', 'AltaTrabajador.xhtml'),
...
-- Volcando datos para la tabla gestempresarial.tbltrabajadores: ~3 rows (aproximadamente)
...
INSERT INTO `tbltrabajadores` (`IdTrabajador`, `NIFtrab`, `IdRol`, `id_Empresa`, `Fecha`, `usuario`, `contrasenya`, `nombretrab`, `apellidostrab`, `direcciontrab`, `Telefonotrab`, `e_mailtrab`, `Fecha_inicio`, `fecha_fin`, `activotrab`) VALUES
	(1, '', 3, 1, '0000-00-00', NULL, NULL, '', '', '', 0, NULL, '0000-00-00', NULL, NULL),
	(2, '09807478w', 3, 1, '2024-05-01', 'admin', 'admin', 'jose maria', 'villafañe marcos', 'calle maestro gregorio alonso', 987698882, 'infjmv00@estudiantes.unileon.es', '2024-05-09', '2024-05-16', b'0'),
	(3, 'pruebecita', 1, 1, '2024-05-01', 'propietario', 'prop', 'juanito', 'valderrama', 'prueba', 12345678, 'hemsa@gmail.com', '2024-05-01', '2024-05-01', b'1');
